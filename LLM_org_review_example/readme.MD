...
An AI-powered demo that analyses organization reviews and generates rating and summary using **React**, **FastAPI**, and local **Ollama** LLMs. Also generates prompt stats for basic understanding.
